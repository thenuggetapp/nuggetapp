...
import { Search, MapPin, Globe, Clock, Navigation, ChevronDown } from "lucide-react";
...
export function SearchSection({ defaultCity, onLocationDetected }: SearchSectionProps = {}) {
        ...
        {!detectedCity && (
          <div ref={cityDropdownRef} className="relative hidden md:block">
            ...
            >
              ...
              <ChevronDown className={`h-4 w-4 text-red-400 transition-transform ${showCityDropdown ? 'rotate-180' : ''}`} />
            </button>
              ...
              <div className="absolute top-full right-0 mt-2 bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-50 w-64">
                ...
                >
                  <div className="flex items-center gap-3">
                    <Navigation className={`h-5 w-5 text-[#8dbf65] ${isDetectingLocation ? 'animate-pulse' : ''}`} />
