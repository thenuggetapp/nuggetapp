...
export function FilterPanel({ onFilterChange, expanded = false, searchQuery = '', city = '', isSearching = false, currentFilters }: FilterPanelProps) {
  ...
  const toggleFilter = (key: keyof Omit<FilterState, 'cuisines'>, e?: React.MouseEvent | React.PointerEvent) => {
    if (e) {
      e.preventDefault();
      e.stopPropagation();
    }
  ...
  const toggleCuisine = (cuisine: string, e?: React.MouseEvent | React.PointerEvent) => {
    if (e) {
      e.preventDefault();
      e.stopPropagation();
    }
  ...
  const allFilterCategories = [
    {
      ...
      filters: [
        ...
        { key: 'babyChangeWomens' as keyof Omit<FilterState, 'cuisines'>, icon: Droplets, label: 'Baby Change\n(Women)' },
        { key: 'babyChangeUnisex' as keyof Omit<FilterState, 'cuisines'>, icon: Droplets, label: 'Baby Change\n(Unisex)' },
        { key: 'babyChangeMens' as keyof Omit<FilterState, 'cuisines'>, icon: Droplets, label: 'Baby Change\n(Men)' },
            ...
            <div key={category.title}>
              ...
              <div className="grid grid-cols-2 gap-3">
                {category.filters.map(({ key, icon: Icon, label }) => (
                  ...
                  >
                    {key === 'highChairs' ? (
                      <img src="/high-chairs copy.png" alt="High Chairs" className="h-7 w-7 object-contain" />
                    ) : key === 'kidsMenu' ? (
                      <img src="/kids-menu.png" alt="Kids Menu" className="h-7 w-7 object-contain" />
                    ) : key === 'babyChangeWomens' ? (
                      <img src="/baby-change-womens.png" alt="Baby Change Women" className="h-7 w-7 object-contain" />
                    ) : key === 'babyChangeUnisex' ? (
                      <img src="/baby-change-unisex.png" alt="Baby Change Unisex" className="h-7 w-7 object-contain" />
                    ) : key === 'babyChangeMens' ? (
                      <img src="/baby-change-mens.png" alt="Baby Change Mens" className="h-7 w-7 object-contain" />
                    ) : key === 'veganOptions' ? (
                      <img src="/vegan.png" alt="Vegan" className="h-7 w-7 object-contain" />
                    ) : key === 'vegetarianOptions' ? (
                      <img src="/vegetarian.png" alt="Vegetarian" className="h-7 w-7 object-contain" />
                    ) : key === 'dogFriendly' ? (
                      <img src="/dog-friendly.png" alt="Dog Friendly" className="h-7 w-7 object-contain" />
                    ) : key === 'wheelchairAccess' ? (
                      <img src="/wheelchair.png" alt="Wheelchair Access" className="h-7 w-7 object-contain" />
                    ) : key === 'glutenFreeOptions' ? (
                      <img src="/gluten-free.png" alt="Gluten Free" className="h-7 w-7 object-contain" />
                    ) : key === 'outdoorSeating' ? (
                      <img src="/outdoor copy.png" alt="Outdoor Seating" className="h-7 w-7 object-contain" />
                    ) : key === 'playgroundNearby' ? (
                      <img src="/playground_nearby.png" alt="Playground Nearby" className="h-7 w-7 object-contain" />
                    ) : key === 'kidsColoring' ? (
                      <img src="/kids-colouring.png" alt="Kids Coloring" className="h-7 w-7 object-contain" />
                    ) : key === 'teenFavourite' ? (
                      <img src="/teen-favourite.png" alt="Teen Favourite" className="h-7 w-7 object-contain" />
                    ) : key === 'pramStorage' ? (
                      <img src="/pram-storage.png" alt="Pram Storage" className="h-7 w-7 object-contain" />
                    ) : key === 'kidsPottyToilet' ? (
                      <img src="/kids-potty-toilet.png" alt="Kids Potty/Toilet" className="h-7 w-7 object-contain" />
                    ) : key === 'kidsPlaySpace' ? (
                      <img src="/kids-play-space.png" alt="Kids Play Space" className="h-7 w-7 object-contain" />
                    ) : key === 'gamesAvailable' ? (
                      <img src="/games-available.png" alt="Games Available" className="h-7 w-7 object-contain" />
                    ) : key === 'kosher' ? (
                      <img src="/kosher copy.png" alt="Kosher" className="h-7 w-7 object-contain" />
                    ) : key === 'halal' ? (
                      <img src="/halal copy.png" alt="Halal" className="h-7 w-7 object-contain" />
                    ) : key === 'smallPlates' ? (
                      <img src="/small-plates copy.png" alt="Small Plates" className="h-7 w-7 object-contain" />
                    ) : key === 'touristAttractionNearby' ? (
                      <img src="/tourist-attraction-nearby copy.png" alt="Tourist Attraction" className="h-7 w-7 object-contain" />
                    ) : key === 'airConditioning' ? (
                      <img src="/air-conditioning copy.png" alt="Air Conditioning" className="h-7 w-7 object-contain" />
                    ) : key === 'healthyOptions' ? (
                      <img src="/healthy-options.png" alt="Healthy Options" className="h-7 w-7 object-contain" />
                    ) : key === 'funQuirky' ? (
                      <img src="/fun.png" alt="Fun & Quirky" className="h-7 w-7 object-contain" />
                    ) : key === 'relaxed' ? (
                      <img src="/relaxed copy.png" alt="Relaxed" className="h-7 w-7 object-contain" />
                    ) : key === 'posh' ? (
                      <img src="/posh copy.png" alt="Posh" className="h-7 w-7 object-contain" />
                    ) : key === 'takeaway' ? (
                      <img src="/takeaway-available copy.png" alt="Takeaway" className="h-7 w-7 object-contain" />
                    ) : key === 'freeKidsMeal' ? (
                      <img src="/free-kids-meal.png" alt="Free Kids Meal" className="h-7 w-7 object-contain" />
                    ) : key === 'buzzy' ? (
                      <img src="/buzzy.png" alt="Buzzy" className="h-7 w-7 object-contain" />
                    ) : key === 'quickService' ? (
                      <img src="/quick-service.png" alt="Quick Service" className="h-7 w-7 object-contain" />
                    ) : key === 'goodForGroups' ? (
                      <img src="/good-for-groups.png" alt="Good for Groups" className="h-7 w-7 object-contain" />
                    ) : key === 'friendlyStaff' ? (
                      <img src="/friendly-staff.png" alt="Friendly Staff" className="h-7 w-7 object-contain" />
                    ) : (
