...
export default function RestaurantDetail({ slug }: RestaurantDetailProps) {
  ...
  const { restaurant: restaurantData, isLoading: loading } = useRestaurantDetail(slug);
        ...
        <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
          <SheetContent side="left" className="w-80 p-0">
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto p-6" tabIndex={0} role="region" aria-label="Map and actions">
      ...
      <div className="restaurant-detail-layout flex-1 flex flex-col lg:ml-16 w-full lg:flex-row">
        <div className="detail-content-wrapper flex-1 flex flex-col overflow-hidden relative">
          ...
          <div className="detail-panels-container flex flex-1 overflow-hidden flex-col lg:flex-row lg:pt-0">
            <div className="detail-panels-scroll-wrapper w-full lg:flex-1 flex flex-col lg:flex-row bg-white overflow-y-auto pb-20 lg:pb-0" tabIndex={0} role="main" aria-label="Restaurant details">
            <div className="restaurant-info-column flex-1 lg:w-[65%] flex flex-col lg:border-r border-slate-200">
              ...
              <div className="restaurant-details-content flex-1 p-4 lg:p-6 space-y-4 lg:space-y-6 overflow-y-auto" tabIndex={0} role="article" aria-label="Restaurant information">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {restaurant.nuggetVerified && (
                        <Badge className="bg-[#8dbf65] hover:bg-[#7aaa56] text-white border-0 flex items-center gap-1 px-2 py-0.5">
                          ...
                          <span className="text-xs font-medium">Nugget Verified</span>
                        </Badge>
                      )}
                    </div>
                  </div>
                ...
                <div className="mobile-family-features lg:hidden">
                  ...
                  <div className="features-grid grid grid-cols-2 gap-2">
                    {restaurant.kidsMenu && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/kids-menu.png" alt="Kids Menu" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.highChairs && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/high-chairs copy.png" alt="High Chairs" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.playgroundNearby && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/playground_nearby.png" alt="Playground Nearby" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.kidsPlaySpace && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/kids-play-space.png" alt="Kids Play Space" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.kidsColoring && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/kids-colouring.png" alt="Kids Coloring" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.gamesAvailable && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/games-available.png" alt="Games Available" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.freeKidsMeal && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/free-kids-meal.png" alt="Free Kids Meal" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.babyChangeWomens && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/baby-change-womens.png" alt="Baby Change Women" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.babyChangeMens && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/baby-change-mens.png" alt="Baby Change Mens" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.babyChangeUnisex && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/baby-change-unisex.png" alt="Baby Change Unisex" className="h-4 w-4 object-contain" />
                        </div>
                    ...
                    {restaurant.pramStorage && (
                      <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                          <img src="/pram-storage.png" alt="Pram Storage" className="h-4 w-4 object-contain" />
                        </div>
                ...
                {(restaurant.vegetarianOptions || restaurant.veganOptions || restaurant.glutenFreeOptions || restaurant.halal || restaurant.kosher || restaurant.healthyOptions) && (
                  <div className="mobile-dietary-options lg:hidden border-t border-slate-200 pt-4">
                    <h2 className="section-title text-base font-bold text-slate-900 mb-3">Dietary Options</h2>
                    <div className="features-grid grid grid-cols-2 gap-2">
                      {restaurant.vegetarianOptions && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/vegetarian.png" alt="Vegetarian" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Vegetarian</span>
                        </div>
                      )}
                      {restaurant.veganOptions && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/vegan.png" alt="Vegan" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Vegan</span>
                        </div>
                      )}
                      {restaurant.glutenFreeOptions && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/gluten-free.png" alt="Gluten Free" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Gluten-Free</span>
                        </div>
                      )}
                      {restaurant.halal && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/halal copy.png" alt="Halal" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Halal</span>
                        </div>
                      )}
                      {restaurant.kosher && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/kosher copy.png" alt="Kosher" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Kosher</span>
                        </div>
                      )}
                      {restaurant.healthyOptions && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/healthy-options.png" alt="Healthy Options" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Healthy Options</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                {(restaurant.wheelchairAccess || restaurant.outdoorSeating || restaurant.dogFriendly || restaurant.airConditioning) && (
                  <div className="mobile-accessibility-amenities lg:hidden border-t border-slate-200 pt-4">
                    <h2 className="section-title text-base font-bold text-slate-900 mb-3">Accessibility & Amenities</h2>
                    <div className="features-grid grid grid-cols-2 gap-2">
                      {restaurant.wheelchairAccess && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/wheelchair.png" alt="Wheelchair Access" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Wheelchair Access</span>
                        </div>
                      )}
                      {restaurant.outdoorSeating && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/outdoor copy.png" alt="Outdoor Seating" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Outdoor Seating</span>
                        </div>
                      )}
                      {restaurant.dogFriendly && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/dog-friendly.png" alt="Dog Friendly" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Dog Friendly</span>
                        </div>
                      )}
                      {restaurant.airConditioning && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/air-conditioning copy.png" alt="Air Conditioning" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Air Conditioning</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                {(restaurant.takeaway || restaurant.quickService || restaurant.goodForGroups || restaurant.buzzy || restaurant.relaxed || restaurant.posh || restaurant.funQuirky) && (
                  <div className="mobile-service-atmosphere lg:hidden border-t border-slate-200 pt-4">
                    <h2 className="section-title text-base font-bold text-slate-900 mb-3">Service & Atmosphere</h2>
                    <div className="features-grid grid grid-cols-2 gap-2">
                      {restaurant.takeaway && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/takeaway-available copy.png" alt="Takeaway" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Takeaway</span>
                        </div>
                      )}
                      {restaurant.quickService && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/quick-service.png" alt="Quick Service" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Quick Service</span>
                        </div>
                      )}
                      {restaurant.goodForGroups && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/good-for-groups.png" alt="Good for Groups" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Good for Groups</span>
                        </div>
                      )}
                      {restaurant.buzzy && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/buzzy.png" alt="Buzzy" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Buzzy</span>
                        </div>
                      )}
                      {restaurant.relaxed && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/relaxed copy.png" alt="Relaxed" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Relaxed</span>
                        </div>
                      )}
                      {restaurant.posh && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/posh copy.png" alt="Posh" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Upscale</span>
                        </div>
                      )}
                      {restaurant.funQuirky && (
                        <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200">
                          <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/fun.png" alt="Fun & Quirky" className="h-4 w-4 object-contain" />
                          </div>
                          <span className="text-xs font-medium text-slate-900">Fun & Quirky</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="desktop-action-buttons hidden lg:block">
                  <div className="action-buttons-group flex gap-2">
                    ...
                    {restaurant.websiteUrl && (
                      ...
                      >
                        <a href={restaurant.websiteUrl} target="_blank" rel="noopener noreferrer" aria-label="Visit restaurant website">
                  ...
                  {restaurant.phone && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href={`tel:${restaurant.phone}`} className="text-sm lg:text-base text-[#4a7c37] hover:underline font-medium" aria-label={`Call ${restaurant.name}`}>{restaurant.phone}</a>
                      </div>
                    </div>
                  )}
                  ...
                  {restaurant.openingTimes && (
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-full">
                        <p className="font-medium text-sm lg:text-base text-slate-900 mb-2">Hours</p>
                        <div className="space-y-1">
                          {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => {
                            ...
                            return (
                              <div key={day} className="flex text-sm lg:text-base">
                                <span className="text-slate-900 font-medium">{displayDay}:</span>
                                <span className="text-slate-600 ml-1">{dayData.open} - {dayData.close}</span>
                              </div>
                            );
                          })}
                        </div>
            ...
            <div className="features-sidebar hidden lg:block w-full lg:w-[30%] p-6 bg-slate-50 border-t lg:border-t-0 lg:border-l border-slate-200 overflow-y-auto" tabIndex={0} role="complementary" aria-label="Family features">
                ...
                <div className="features-list space-y-3">
                  {restaurant.kidsMenu && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/kids-menu.png" alt="Kids Menu" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.highChairs && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/high-chairs copy.png" alt="High Chairs" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.playgroundNearby && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/playground_nearby.png" alt="Playground Nearby" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.kidsPlaySpace && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/kids-play-space.png" alt="Kids Play Space" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.kidsColoring && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/kids-colouring.png" alt="Kids Coloring" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.gamesAvailable && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/games-available.png" alt="Games Available" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.freeKidsMeal && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/free-kids-meal.png" alt="Free Kids Meal" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.babyChangeWomens && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/baby-change-womens.png" alt="Baby Change Women" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.babyChangeMens && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/baby-change-mens.png" alt="Baby Change Mens" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.babyChangeUnisex && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/baby-change-unisex.png" alt="Baby Change Unisex" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  {restaurant.pramStorage && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                      <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                        <img src="/pram-storage.png" alt="Pram Storage" className="h-5 w-5 object-contain" />
                      </div>
                      <div>
                  ...
                  <>
                    ...
                    <div className="dietary-options-list space-y-3">
                      {restaurant.vegetarianOptions && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/vegetarian.png" alt="Vegetarian" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.veganOptions && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/vegan.png" alt="Vegan" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.glutenFreeOptions && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/gluten-free.png" alt="Gluten Free" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.halal && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/halal copy.png" alt="Halal" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.kosher && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/kosher copy.png" alt="Kosher" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.healthyOptions && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <img src="/healthy-options.png" alt="Healthy Options" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                  ...
                  <>
                    ...
                    <div className="amenities-list space-y-3">
                      {restaurant.wheelchairAccess && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/wheelchair.png" alt="Wheelchair Access" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.outdoorSeating && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/outdoor copy.png" alt="Outdoor Seating" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.dogFriendly && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/dog-friendly.png" alt="Dog Friendly" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.airConditioning && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <img src="/air-conditioning copy.png" alt="Air Conditioning" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                  ...
                  <>
                    ...
                    <div className="service-atmosphere-list space-y-3">
                      {restaurant.takeaway && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/takeaway-available copy.png" alt="Takeaway" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.quickService && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/quick-service.png" alt="Quick Service" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.goodForGroups && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/good-for-groups.png" alt="Good for Groups" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.buzzy && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/buzzy.png" alt="Buzzy" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.relaxed && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/relaxed copy.png" alt="Relaxed" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.posh && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/posh copy.png" alt="Posh" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
                      ...
                      {restaurant.funQuirky && (
                        <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                          <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <img src="/fun.png" alt="Fun & Quirky" className="h-5 w-5 object-contain" />
                          </div>
                          <div>
