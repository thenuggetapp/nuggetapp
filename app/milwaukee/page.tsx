...
export default async function Milwaukee() {
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="space-y-4 mt-[120px] md:mt-24">
                <h1 className="text-[2.8125rem] sm:text-4xl md:text-5xl lg:text-6xl font-extralight text-white tracking-tight font-serif drop-shadow-lg leading-[1] sm:leading-tight">
                  Search for family friendly restaurants in Milwaukee
                </h1>
              </div>

              <SearchSection defaultCity="Milwaukee" />
            </div>
          </div>
        </div>

        <main>
          <PopularFilters location="Milwaukee" filterCounts={filterCounts} />

          <RestaurantCarousel
            restaurants={featuredRestaurants}
            title="Milwaukee restaurants with high chairs"
            titleLink="/search?q=Milwaukee&high_chairs=true"
          />

          <RestaurantCarousel
            restaurants={dogFriendlyRestaurants}
            title="Milwaukee restaurants that are dog friendly"
            titleLink="/search?q=Milwaukee&dog_friendly=true"
          />

          <RestaurantCarousel
            restaurants={babyChangeRestaurants}
            title="Milwaukee restaurants with baby change"
            titleLink="/search?q=Milwaukee&baby_change=true"
          />

          <RestaurantCarousel
            restaurants={kidsColouringRestaurants}
            title="Milwaukee restaurants with kids colouring"
            titleLink="/search?q=Milwaukee&kids_colouring=true"
          />
        </main>
    </div>
    </>
