      ...
      <div className="min-h-screen">
        <div className="relative min-h-[500px] md:min-h-[600px] md:m-10 md:rounded-t-xl">
          <div className="absolute inset-0 z-0 md:rounded-t-xl md:overflow-hidden">
            <img
              src="/london_hero.jpg"
              alt="London street scene with festive lights"
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="space-y-4 mt-[120px] md:mt-24">
                <h1 className="text-[2.8125rem] sm:text-4xl md:text-5xl lg:text-6xl font-extralight text-white tracking-tight font-serif drop-shadow-lg leading-[1] sm:leading-tight">
                  Search for family friendly restaurants in London
                </h1>
              </div>

              <SearchSection defaultCity="London" />
            </div>
          </div>
        </div>

        <main>
          <PopularFilters location="London" filterCounts={filterCounts} />

          <RestaurantCarousel
            restaurants={featuredRestaurants}
            title="London restaurants with high chairs"
            titleLink="/search?q=London&high_chairs=true"
          />

          <RestaurantCarousel
            restaurants={dogFriendlyRestaurants}
            title="London restaurants that are dog friendly"
            titleLink="/search?q=London&dog_friendly=true"
          />

          <RestaurantCarousel
            restaurants={babyChangeRestaurants}
            title="London restaurants with baby change"
            titleLink="/search?q=London&baby_change=true"
          />

          <RestaurantCarousel
            restaurants={kidsColouringRestaurants}
            title="London restaurants with kids colouring"
            titleLink="/search?q=London&kids_colouring=true"
          />
        </main>
    </div>
    </>
