...
export default async function SanFrancisco() {
      ...
      <div className="min-h-screen">
        <div className="relative min-h-[500px] md:min-h-[600px] md:m-10 md:rounded-t-xl">
          <div className="absolute inset-0 z-0 md:rounded-t-xl md:overflow-hidden">
            <img
              src="/sanfransico-hero-01.jpg"
              alt="San Francisco cable car with Bay Bridge"
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="space-y-4 mt-[120px] md:mt-24">
                <h1 className="text-[2.8125rem] sm:text-4xl md:text-5xl lg:text-6xl font-extralight text-white tracking-tight font-serif drop-shadow-lg leading-[1] sm:leading-tight">
                  Search for family friendly restaurants in San Francisco
                </h1>
              </div>

              <SearchSection defaultCity="San Francisco" />
            </div>
          </div>
        </div>

        <main>
          <PopularFilters location="San Francisco" filterCounts={filterCounts} />

          <RestaurantCarousel
            restaurants={featuredRestaurants}
            title="San Francisco restaurants with high chairs"
            titleLink="/search?q=San Francisco&high_chairs=true"
          />

          <RestaurantCarousel
            restaurants={dogFriendlyRestaurants}
            title="San Francisco restaurants that are dog friendly"
            titleLink="/search?q=San Francisco&dog_friendly=true"
          />

          <RestaurantCarousel
            restaurants={babyChangeRestaurants}
            title="San Francisco restaurants with baby change"
            titleLink="/search?q=San Francisco&baby_change=true"
          />

          <RestaurantCarousel
            restaurants={kidsColouringRestaurants}
            title="San Francisco restaurants with kids colouring"
            titleLink="/search?q=San Francisco&kids_colouring=true"
          />
        </main>
    </div>
    </>
